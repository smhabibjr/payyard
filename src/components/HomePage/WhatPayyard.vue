<template>
  <div class="gpt3__whatgpt3 section__margin" id="wgpt3">
    <div class="gpt3__whatgpt3-feature">
      <PayyardFeature title="What is GPT-3" :text="text" />
    </div>
    ...
    <div class="gpt3__whatgpt3-container">
      <PayyardFeature title="Chatbots" :text="chatbots" />
      <PayyardFeature title="Knowledgebase" :text="knowledgebase" />
      <PayyardFeature title="Education" :text="education" />
    </div>
  </div>
</template>
...
const knowledgebase = 'At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments b';
const education = 'At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments b';
</script>
...
.gpt3__whatgpt3 {
    ...
    background:-moz-radial-gradient(
      circle at 30% -100%, #042c54 25%, rgba(4, 44, 84, 1) 85%, rgba(27, 120, 222, 1) 100%);
